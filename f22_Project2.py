'''Name: Neha Kotagiri
Uniqname: kotagiri@umich.edu
People Worked with: Emily Veguilla, Lindsay Nelson, Meera Agarwal, Kevin Song
'''
...
def check_policy_numbers(data):
    ...
    """
    #data = list of tuples returned by get_detailed_listing_database
    id_list = []
